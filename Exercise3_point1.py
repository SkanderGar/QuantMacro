...
grid = np.linspace(-1,1,size_grid)
nodes = uf.select_node(num_nodes, grid)
para = uf.find_theta_test(expo_f,nodes,order)
...
ax.set_xlabel('x')
ax.set_ylabel('f(x)')
ax.set_title('Appoximations of exp(1/x)')
ax.set_ylim(-1*10**(11),5*10**(11))
ax_diff.set_ylim(-1*10**(11),5*10**(11))
#ax.margin(x = (0,0.2), y = (-0.5,0.5))

################################################
grid1 = np.linspace(-1,1,size_grid)
nodes1 = uf.select_node(num_nodes, grid1)
para1 = uf.find_theta_test(runge_f,nodes1,order)
...
ax1.set_xlabel('x')
ax1.set_ylabel('f(x)')
ax1.set_title('Appoximations of 1/(1+25*x**2)')



#################################################

grid2 = np.linspace(-1,1,size_grid)
nodes2 = uf.select_node(num_nodes, grid2)
para2 = uf.find_theta_test(ramp_f,nodes2,order)
...
ax2.set_xlabel('x')
ax2.set_ylabel('f(x)')
ax2.set_title('Appoximations of (x+|x|)/2')
...
order_o5 = 6
func_o5 = [lambda x, n=i: x**n for i in range(order_o5)]
############################################


############################################
para_o5 = uf.find_theta_test(expo_f,nodes,order_o5)
...
################################################
para1_o5 = uf.find_theta_test(runge_f,nodes1,order_o5)
...
#################################################
para2_o5 = uf.find_theta_test(ramp_f,nodes2,order_o5)
...
order_o10 = 11
func_o10 = [lambda x, n=i: x**n for i in range(order_o10)]
num_nodes_o10 = 40
############################################

############################################
nodes_o10 = uf.select_node(num_nodes_o10, grid)
para_o10 = uf.find_theta_test(expo_f,nodes_o10,order_o10)
...
para1_o10 = uf.find_theta_test(runge_f,nodes1_o10,order_o10)
...
para2_o10 = uf.find_theta_test(ramp_f,nodes2_o10,order_o10)
