...
ax.set_xlabel('x')
ax.set_ylabel('f(x)')
ax.set_title('Chebyshev interpolation nodes exp(1/x)')
ax_diff.set_xlabel('x')
ax_diff.set_ylabel('f(x)')
ax_diff.set_title('Chebyshev interpolation nodes error')
ax.set_ylim(-1*10**(2),5*10**(2))
ax_diff.set_ylim(-1*10**(2),5*10**(2))
...
ax1.set_xlabel('x')
ax1.set_ylabel('f(x)')
ax1.set_title('Chebyshev interpolation nodes 1/(1+25*x**2)')
ax1_diff.set_xlabel('x')
ax1_diff.set_ylabel('f(x)')
ax1_diff.set_title('Chebyshev interpolation nodes error')
...
ax2.set_xlabel('x')
ax2.set_ylabel('f(x)')
ax2.set_title('Chebyshev interpolation nodes (x+|x|)/2')
ax2_diff.set_xlabel('x')
ax2_diff.set_ylabel('f(x)')
ax2_diff.set_title('Chebyshev interpolation nodes error')
